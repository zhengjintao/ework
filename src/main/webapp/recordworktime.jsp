...
function getSettedtime()
{
	...
	$.ajax({ 
	    ...
	    success: function (data) {
	    	...
	    	$("#beginlbl").html("1" == data.settedFlg ? "已签" : "出勤")
	    	$("#endlbl").html("1" == data.settedFlg ? "已签" : "退勤")
...
function deleteData()
{
	$.ajax({ 
	    type: "post", 
	    url: "./recordworktime.do?" + $("form").serialize() + "&deleteFlg=1", 
	    dataType: "json", 
	    success: function (data) {
	    	$("#wbegin").val(data.defaultBeginTime)
	    	$("#wend").val(data.defaultEndTime)
...
<body>
   <script type="text/javascript">
	...
	<div class="ui one column grid container">
		<div class="column">
			<form action="./recordworktime.do" method="post" onsubmit="return checkdate();">
				<div class="ui teal inverted segment">
					<div class="ui inverted form">
						<div class="inline field">
							<div class="field">
								<input type="date" id="wdate" name="wdate" onchange="getSettedtime()"
						...
						<div class="inline fields">
								<div class="field">
									<input type="time" name="wbegin" id="wbegin" style="min-width:110px;"
								...
								<div class="field">
									<Button class="ui active teal button">
					          		<i class="add to calendar icon"></i> <span id="beginlbl"><%=(String) request.getAttribute("beginlbl")%></span>
					              	</Button>
								</div>
						</div>
						<div class="inline fields">
								<div class="field">
									<input type="time" name="wend" id="wend" style="min-width:110px;"
										value=<%=(String) request.getAttribute("defaultEndTime")%>><br>
								</div>

								<div class="field">
									<Button class="ui active teal button">
					          		<i class="add to calendar icon"></i> <span id="endlbl"><%=(String) request.getAttribute("endlbl")%></span>
					              	</Button>
								</div>
						</div>
	...
	<footer>
		<div class="ui yellow four item menu">
			...
			</a> <a class="active item" href="recordworktime.do"> <i class="calendar icon"></i>
				出勤
